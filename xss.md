### 防止xss攻击
* 在web中添加过滤filter类，继承javax.servlet.Filter
* 添加XssRequestWrapper类，继承javax.servlet.http.HttpServletRequestWrapper；并重写getHeader、getParameter、getParameterMap、getParameterValues方法将参数过滤
    
<font color="#4F94CD">实现由开源项目: <font color="red">antisamy</font> </font>
     ...
     <anti-samy-rules xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
     	...
     	<common-attributes> 
     		...
     		<attribute name="href"> 
     			...
     			<literal-list> 
     				<literal value="javascript:history.go(0)"/> 
     				<literal value="javascript:history.go(-1)"/> 
     				<literal value="javascript:void(0)"/> 
     				<literal value="javascript:location.reload()"/> 
     			</literal-list> 
     		</attribute> 
     	...
     	<tag-rules> 
     		...
     		<tag name="img" action="validate"> 
     			...
     			<attribute name="_src" onInvalid="removeTag"> 
     				<regexp-list> 
     					<regexp name="onsiteURL"/> 
     					<regexp name="offsiteURL"/> 
     				</regexp-list> 
...
private static Policy policy = null;  
    ...
    // 双引号排除
    private String xssClean2(String value) {  
        AntiSamy antiSamy = new AntiSamy();  
        try { 
            final CleanResults cr = antiSamy.scan(value, policy);  
            //安全的HTML输出
